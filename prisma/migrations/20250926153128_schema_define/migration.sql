...
-- CreateIndex
CREATE INDEX "Category_slug_name_idx" ON "public"."Category"("slug", "name");
...
-- CreateIndex
CREATE INDEX "Brand_slug_name_idx" ON "public"."Brand"("slug", "name");

-- CreateIndex
CREATE UNIQUE INDEX "Product_slug_key" ON "public"."Product"("slug");

-- CreateIndex
CREATE INDEX "Product_slug_name_idx" ON "public"."Product"("slug", "name");

-- CreateIndex
CREATE INDEX "Order_user_id_address_id_idx" ON "public"."Order"("user_id", "address_id");

-- CreateIndex
CREATE UNIQUE INDEX "Payment_transaction_id_key" ON "public"."Payment"("transaction_id");

-- CreateIndex
CREATE INDEX "Payment_order_id_id_idx" ON "public"."Payment"("order_id", "id");
